...
from apps.reservations.views import ReservationCreateView, CheckReservationView, CancelReservationView, \
    ApproveReservationView, ApartmentBookedDatesView, LandlordReservationListView, CheckReservationView
...
urlpatterns = [
    ...
    path("landlord/", LandlordReservationListView.as_view()),
    path("user/", CheckReservationView.as_view()),
    path('cancel/<int:pk>/', CancelReservationView.as_view(), name='reservation-cancel'),
